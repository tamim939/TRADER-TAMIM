...
const APP_PASSWORD = 'text.txt'; // User specified password
...
export const AppLock: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const telegramLink = `https://t.me/TRADER_TAMIM_3?text=${encodeURIComponent('ভাইয়া আপনার হ্যাকের পাসওয়ার্ডটি নিতে হলে আমার কি করতে হবে')}`;
